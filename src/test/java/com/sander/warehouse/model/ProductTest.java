...
class ProductTest {
    ...
    void constructorThrowsExceptionWhenIdIsNotPositive() {
        assertThrows(IllegalArgumentException.class, () -> new Product(0, "Product1", 10, 19.99F));
    }

    @Test
    void constructorThrowsExceptionWhenNameIsNull() {
        assertThrows(IllegalArgumentException.class, () -> new Product(1, null, 10, 19.99F));
    }

    @Test
    void constructorThrowsExceptionWhenNameIsBlank() {
        assertThrows(IllegalArgumentException.class, () -> new Product(1, "   ", 10, 19.99F));
    }

    @Test
    void constructorThrowsExceptionWhenQuantityIsNegative() {
        assertThrows(IllegalArgumentException.class, () -> new Product(1, "Product1", -1, 19.99F));
    }

    @Test
    void constructorThrowsExceptionWhenPriceIsNegative() {
        assertThrows(IllegalArgumentException.class, () -> new Product(1, "Product1", 10, -1.0F));
    }
    ...
    void setPriceThrowsExceptionWhenPriceIsNegative() {
        ...
        assertThrows(IllegalArgumentException.class, () -> product.setPrice(-1.0F));
    }
